import type { ExamMaterialStatus } from "../types/exam_material.type";

// TODO: đối chiếu lại đúng enum status thật từ BE, đây là map tạm
const config: Record<ExamMaterialStatus, { label: string; className: string }> = {
...
export default function ExamMaterialStatusBadge({ status }: { status: ExamMaterialStatus }) {
